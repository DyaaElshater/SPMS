...
/*
        ...
        adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, parkingPlaces);
        ...
        spinner1.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
              ...
              Toast.makeText(adapterView.getContext(), "OnItemSelectedListener : " + adapterView.getItemAtPosition(position).toString(),
  ...
  */
    ...
    /*private void buildAlertMessageNoGps(){
        ...
        builder.setMessage("Do you want to enable your GPS ?").setCancelable(false)
    ...
    /*public void RadioClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.list:
                if (check){
                    spinner1.setVisibility(View.VISIBLE);
                    spinner1.setPrompt("select place");
                }
            break;
            ...
            location.addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(decision.this,"unable to get your current location",Toast.LENGTH_SHORT).show();
                    }
    ...
    public class MyAsyncresources extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result2) {
          ...
          /*  try {
                ...
                JSONArray JA = jArray.getJSONArray("lot");
                //Toast.makeText(getApplicationContext(),jArray.length(),Toast.LENGTH_LONG).show();
                //Log.i("ERROR", Integer.toString(jArray.length()));

                for (int i = 0; i < JA.length(); i++) {

                    JSONObject json = JA.getJSONObject(i);
                    temp0 = json.getString("capacity");
                    temp1 = json.getString("filledSlot");
                    empty.add(i,Integer.toString((Integer.parseInt(temp0) - Integer.parseInt(temp1))));

                }
                /*if (temp0.length() > 0) {

                    Intent MapActivity = new Intent(Log_inActivity.this, MapsActivity.class);
        ...
        /*protected void createLocationRequest() {
            ...
            SettingsClient client = LocationServices.getSettingsClient(decision.this);
